...
public class InputView {
  ...
  public void readBettingAmount(List<Player> playerList) {
    for (Player player: playerList){
      System.out.println(player.getName().getName() + " of Betting Amounts");
      String bettingAmounts = scanner.nextLine();
      isValidBettingAmounts(bettingAmounts);
      player.setDividends(new Money(bettingAmounts));
    }
  }

  private void isValidBettingAmounts(String bettingAmounts) {
