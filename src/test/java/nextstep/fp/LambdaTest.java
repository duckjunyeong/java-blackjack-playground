...
public class LambdaTest {
    ...
    @Test
    public void sumStrategy0() throws Exception {
        int sum = Lambda.sumStrategy(numbers, (num) -> true);
        assertThat(sum).isEqualTo(21);
    }

    @Test
    public void sumStrategy1() throws Exception {
        int sum = Lambda.sumStrategy(numbers, num -> num % 2 == 0);
        assertThat(sum).isEqualTo(12);
    }

    @Test
    public void sumStrategy2() throws Exception {
        int sum = Lambda.sumStrategy(numbers, num -> num > 3);
        assertThat(sum).isEqualTo(15);
    }
}
